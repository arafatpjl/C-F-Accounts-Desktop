...
Private Sub cmdShow_Click()
    ...
    MainConn.BeginTrans
        ...
        If optDetails.Value = True Then
            MainComm.CommandText = "INSERT INTO Temp_Adjust_Statement(JobNo,InvNo,PayDate,IndAmount,BPayDate,OtherPayDate,BPayValue,TotIndValue,AccName,Remarks,AdjDate,AdjAmount,BAdjAmount,OtherAdjAmount,TotAdjust,TotBAmount,AdjTax,AdjVat,compName,compAdd)" _
                & " SELECT new_Indent_Information.JobNo,new_Indent_Information.InvNo,new_Indent_Information.PayDate,new_Indent_Information.IndAmount,new_Indent_Information.BPayDate,new_Indent_Information.OtherPayDate,new_Indent_Information.BPayValue,new_Indent_Information.TotIndValue,new_Acc_Head.AccName," _
                & " new_Indent_Information.Remarks,new_Indent_Information.AdjDate,new_Indent_Information.AdjAmount,new_Indent_Information.BAdjAmount,new_Indent_Information.OtherAdjAmount,new_Indent_Information.TotAdjust,new_Indent_Information.TotBAmount,new_Indent_Information.AdjTax,new_Indent_Information.AdjVat," _
        ...
        Else
            If chkPSA.Value = 1 And chkRest.Value = 0 Then
                MainComm.CommandText = "INSERT INTO Temp_Adjust_Statement(AdjDate,TotIndValue,TotAdjust,AdjTax,compName,compAdd)SELECT new_Indent_Information.AdjDate,Sum(new_Indent_Information.TotIndValue) AS TotalIndent," _
                    & " Sum(new_Indent_Information.TotAdjust) AS TotalAdjust,Sum(TotIndValue - TotAdjust) AS Balance,Company_Information.compName,Company_Information.compAdd" _
                    ...
                    & " And ((new_Indent_Information.Status)='" & strStatus & "') And ((new_Indent_Information.compID)=" & bytCompID & ")) GROUP BY new_Indent_Information.AdjDate,Company_Information.compName," _
                    & " Company_Information.compAdd HAVING (((new_Indent_Information.AdjDate) Between '" & varBeginDate & "' And '" & varEndDate & "'));"
            ElseIf chkPSA.Value = 0 And chkRest.Value = 1 Then
                MainComm.CommandText = "INSERT INTO Temp_Adjust_Statement(AdjDate,TotIndValue,TotAdjust,AdjTax,compName,compAdd)SELECT new_Indent_Information.AdjDate,Sum(new_Indent_Information.TotIndValue) AS TotalIndent," _
                    & " Sum(new_Indent_Information.TotAdjust) AS TotalAdjust,Sum(TotIndValue - TotAdjust) AS Balance,Company_Information.compName,Company_Information.compAdd" _
                    & " FROM new_Indent_Information INNER JOIN Company_Information ON new_Indent_Information.compID = Company_Information.compID WHERE ((RIGHT(new_Indent_Information.JobNo,3) <> 'PSA')" _
            ...
            Else
                MainComm.CommandText = "INSERT INTO Temp_Adjust_Statement(AdjDate,TotIndValue,TotAdjust,AdjTax,compName,compAdd)SELECT new_Indent_Information.AdjDate,Sum(new_Indent_Information.TotIndValue) AS TotalIndent," _
                    ...
                    & " And ((new_Indent_Information.compID)=" & bytCompID & ")) GROUP BY new_Indent_Information.AdjDate,Company_Information.compName,Company_Information.compAdd" _
        ...
        If optDetails.Value = True Then
           ...
           ' MainComm.Execute
            ...
            MainComm.CommandText = "INSERT INTO Temp_Summary(AccName,TotAdjust) SELECT AccName,Sum((TotAdjust-(AdjTax+AdjVat))) AS TAdjAmount From Temp_Adjust_Statement GROUP BY AccName;"
            MainComm.Execute


            MainComm.CommandText = "INSERT INTO Temp_Summary(AccName,TotAdjust) SELECT   'INCOME TAX',Sum(AdjTax) AS TAdjTax From Temp_Adjust_Statement ;"
            MainComm.Execute

            MainComm.CommandText = "INSERT INTO Temp_Summary(AccName,TotAdjust) SELECT  'VAT',Sum(AdjVat) AS TAdjVat From Temp_Adjust_Statement;"
            MainComm.Execute
