...
Begin VB.Form frmNewIndentEntry 
   ...
   Begin VB.TextBox txtTotal 
      ...
      TabIndex        =   35
      Text            =   "0.00"
      ToolTipText     =   "Grand Total Indent Value"
      Top             =   4680
      Width           =   2415
   End
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.TextBox txtRemarks 
         ...
         MultiLine       =   -1  'True
         TabIndex        =   8
         ToolTipText     =   "Write Comments About Job No."
         Top             =   1290
         Width           =   3180
      End
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.TextBox txtChequePayValue 
         ...
         TabIndex        =   6
         Text            =   "0.00"
         ToolTipText     =   "Bank Payment Value"
         Top             =   570
         Width           =   2295
      End
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.TextBox txtCashPayValue 
         ...
         TabIndex        =   4
         Text            =   "0.00"
         ToolTipText     =   "cash Payment Value"
         Top             =   600
         Width           =   2295
      End
   ...
   Begin VB.Label Label21 
      BackStyle       =   0  'Transparent
      Caption         =   "Job Indent Total Value"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
...
'    MainConn.BeginTrans
        ...
        If Len(txtPayDate) <> 0 And Len(txtIndentValue) <> 0 And Len(txtChequePayDate) = 0 Then
            ...
            MainComm.CommandText = "INSERT INTO new_Indent_Information_bak(compID,JobNo,InvNo,PayDate,IndAmount,TotIndValue,AdjAmount,BAdjAmount,TotBAmount,TotAdjust,AdjTax,AdjVat,AccID,Remarks,Status,Deleterow,Username,Userpwd,Comname,Entrydate,Entrytime)" _
              & " VALUES(" & bytCompID & ",'" & txtJobNo.Text & "','" & txtInvNo.Text & "','" & Format(txtPayDate.Text, cnstDtFrmtI) & "'," & CCur(txtCashPayValue.Text) & "," _
              & " " & CCur(txtIndentValue.Text) & ",0,0," & CCur(txtIndentValue.Text) & ",0,0,0," & findAccID(cboAccNo.Text) & ",'" & txtRemarks.Text & "','" & strStatus & "',0,'" & struser & "','" & strpass & "','" & getComName & "','" & Date & "','" & Time & "');"
            MainComm.Execute
        ...
        If Len(txtChequePayDate) <> 0 And Len(txtChequePayValue) <> 0 And Len(txtPayDate) = 0 Then
            ...
            MainComm.CommandText = "INSERT INTO new_Indent_Information_bak(compID,JobNo,InvNo,BPayDate,BPayValue,TotIndValue,AdjAmount,BAdjAmount,TotBAmount,TotAdjust,AdjTax,AdjVat,AccID,Remarks,Status,Deleterow,Username,Userpwd,Comname,Entrydate,Entrytime)" _
              & " VALUES(" & bytCompID & ",'" & txtJobNo.Text & "','" & txtInvNo.Text & "','" & Format(txtChequePayDate.Text, cnstDtFrmtI) & "'," & CCur(txtChequePayValue.Text) & "," _
              & " " & CCur(txtIndentValue.Text) & ",0,0," & CCur(txtIndentValue.Text) & ",0,0,0," & findAccID(cboAccNo.Text) & ",'" & txtRemarks.Text & "','" & strStatus & "',0,'" & struser & "','" & strpass & "','" & getComName & "','" & Date & "','" & Time & "');"
            MainComm.Execute
            MainConn.CommitTrans
        ...
        If Len(txtPayDate) <> 0 And Len(txtIndentValue) <> 0 And Len(txtChequePayDate) <> 0 And Len(txtChequePayValue) <> 0 Then
            ...
            MainComm.CommandText = "INSERT INTO new_Indent_Information_bak(compID,JobNo,InvNo,PayDate,IndAmount,BPayDate,BPayValue,TotIndValue,AdjAmount,BAdjAmount,TotBAmount,TotAdjust,AdjTax,AdjVat,AccID,Remarks,Status,Deleterow,Username,Userpwd,Comname,Entrydate,Entrytime)" _
              & " VALUES(" & bytCompID & ",'" & txtJobNo.Text & "','" & txtInvNo.Text & "','" & Format(txtPayDate.Text, cnstDtFrmtI) & "'," & CCur(txtCashPayValue.Text) & ",'" & Format(txtChequePayDate.Text, cnstDtFrmtI) & "'," & CCur(txtChequePayValue.Text) & "," _
              & " " & CCur(txtIndentValue.Text) & ",0,0," & CCur(txtIndentValue.Text) & ",0,0,0," & findAccID(cboAccNo.Text) & ",'" & txtRemarks.Text & "','" & strStatus & "',0,'" & struser & "','" & strpass & "','" & getComName & "','" & Date & "','" & Time & "');"
            MainComm.Execute
            MainConn.CommitTrans
...
If MsgBox("Are you sure to Update", vbQuestion + vbYesNo + vbDefaultButton1, cnstMsgQ) = vbNo Then Exit Sub
    ...
    MainConn.BeginTrans
        MainComm.CommandText = "UPDATE new_Indent_Information SET JobNo='" & txtJobNo.Text & "',InvNo='" & txtInvNo.Text & "',PayDate='" & Format(IIf(txtPayDate.Text <> "", txtPayDate.Text, "JAN-01-1900"), cnstDtFrmtI) & "',IndAmount=" & CCur(txtCashPayValue.Text) & ", " _
            & " BPayDate='" & Format(IIf(txtChequePayDate.Text <> "", txtChequePayDate.Text, "01-JAN-1900"), cnstDtFrmtI) & "',BPayValue=" & CCur(txtChequePayValue.Text) & ",TotIndValue=" & CCur(txtIndentValue.Text) & "," _
        ...
        MainComm.CommandText = "INSERT INTO new_Indent_Information_bak(compID,JobNo,InvNo,PayDate,IndAmount,BPayDate,BPayValue,TotIndValue,AdjAmount,BAdjAmount,TotBAmount,TotAdjust,AdjTax,AdjVat,AccID,Remarks,Status,Deleterow,Username,Userpwd,Comname,Entrydate,Entrytime)" _
              & " SELECT compID,JobNo,InvNo,PayDate,IndAmount,BPayDate,BPayValue,TotIndValue,AdjAmount,BAdjAmount,TotBAmount,TotAdjust,AdjTax,AdjVat,AccID,Remarks,Status,1,'" & struser & "','" & strpass & "','" & getComName & "','" & Date & "','" & Time & "' FROM new_Indent_Information WHERE (compID=" & bytCompID & ")AND (JobNo='" & txtJobNo.Text & "') AND (Status='" & strStatus & "');"
        MainComm.Execute
                                                                                                                      
'        MainComm.CommandText = "INSERT INTO new_Indent_Information_bak(compID,JobNo,InvNo,PayDate,IndAmount,BPayDate,BPayValue,TotIndValue,AdjAmount,BAdjAmount,TotBAmount,TotAdjust,AdjTax,AdjVat,AccID,Remarks,Status,Deleterow,Username,Comname,Entrydate,Entrytime)" _
'              & " VALUES(" & bytCompID & ",'" & txtJobNo.Text & "','" & txtInvNo.Text & "','" & Format(txtPayDate.Text, cnstDtFrmtI) & "'," & CCur(txtCashPayValue.Text) & ",'" & Format(txtChequePayDate.Text, cnstDtFrmtI) & "'," & CCur(txtChequePayValue.Text) & "," _
'              & " " & CCur(txtIndentValue.Text) & ",0,0," & CCur(txtIndentValue.Text) & ",0,0,0," & findAccID(cboAccNo.Text) & ",'" & txtRemarks.Text & "','" & strStatus & "',1,'" & struser & "','" & getComName & "','" & Date & "','" & Time & "');"
'        MainComm.Execute
...
Call txtGotFocus(txtBalance)
End Sub

Private Sub txtIndentValue_GotFocus()
 Call txtGotFocus(txtIndentValue)
End Sub
...
Private Sub txtChequePayDate_GotFocus()
   Call txtGotFocus(txtChequePayDate)
End Sub
...
Call txtGotFocus(txtChequePayValue)
End Sub
...
Call txtGotFocus(txtCashPayValue)
